...
public class GuavaTester {
  ...
  AuthorizationApi authorization = new AuthorizationApi();
      ...
      LoadingCache<String, HttpResponse<String>> employeeCache = 
         CacheBuilder.newBuilder()
            ...
            .build(new CacheLoader<String, HttpResponse<String>>(){ // build the cacheloader
               ...
               @Override
               public HttpResponse<String> load(String empId) throws Exception {
                  //make the expensive call
                  return authorization.authorizationGetRoles();
               } 
            });
      ...
      try {			
         ...
         System.out.println(employeeCache.get("roles").getBody());
         System.out.println(employeeCache.get("role").getBody());
         System.out.println(employeeCache.get("roles").getBody());
         System.out.println(employeeCache.stats().hitCount());
         System.out.println(employeeCache.stats().loadCount());
